...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] palabrasClave = ManejadorArchivosGenerico.leerArchivo("src/claves_insertar.txt");
        String[] palabrasBuscar = ManejadorArchivosGenerico.leerArchivo("src/claves_buscar.txt");
